...
import img1 from './assets/img/avatars/avatar1.jpeg';
import img2 from './assets/img/avatars/avatar2.jpeg';
import img3 from './assets/img/avatars/avatar3.jpeg';
import img4 from './assets/img/avatars/avatar4.jpeg';
import img5 from './assets/img/avatars/avatar5.jpeg';
                ...
                <ul className="nav navbar-nav flex-nowrap ml-auto">
                    ...
                    <li className="nav-item dropdown no-arrow mx-1" role="presentation">
                        <div className="nav-item dropdown no-arrow"><a className="dropdown-toggle nav-link"
                                                                       data-toggle="dropdown" aria-expanded="false"
                                                                       href="#"><span
                            className="badge badge-danger badge-counter">3+</span><i className="fas fa-bell fa-fw"></i></a>
                            <div
                    ...
                    <li className="nav-item dropdown no-arrow" role="presentation">
                        <div className="nav-item dropdown no-arrow"><a className="dropdown-toggle nav-link"
                            ...
                            className="border rounded-circle img-profile" src={img1} /></a>
                            <div
                                className="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu"><a
